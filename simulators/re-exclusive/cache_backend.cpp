    ...
    if (l1Hit == false)
    {
       ...
       if (l1WB == true)
       {
           ...
           if (l2Hit == false)
           {
                ...
                m_llc.insertData(l1EvictAddr, tid, true, l3Hit, l3WB, l3EvictAddr, false, false);
           }
       }
       ...
       if (l2Hit == false)
       {
           ...
           if (l2WB == true)
           {
               ...
               bool l3WB {false};
               intptr_t l3EvictAddr {-1};
               m_llc.insertData(l2EvictAddr, tid, true, l3Hit, l3WB, l3EvictAddr, false, true);
           }
           ...
           bool l3WB {false};
           intptr_t l3EvictAddr {-1};
           m_llc.insertData(addr, tid, isWrite, l3Hit, l3WB, l3EvictAddr, true, false);
